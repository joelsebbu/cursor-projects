...
describe('command-generation/adapters', () => {
  ...
  describe('claudeAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.claude', 'commands', 'ofsx', 'explore.md'));
    });

    it('should generate correct file path for different command IDs', () => {
      expect(claudeAdapter.getFilePath('new')).toBe(path.join('.claude', 'commands', 'ofsx', 'new.md'));
      expect(claudeAdapter.getFilePath('bulk-archive')).toBe(path.join('.claude', 'commands', 'ofsx', 'bulk-archive.md'));
    });
  ...
  describe('cursorAdapter', () => {
    ...
    it('should generate correct file path with ofsx- prefix', () => {
      const filePath = cursorAdapter.getFilePath('explore');
      expect(filePath).toBe(path.join('.cursor', 'commands', 'ofsx-explore.md'));
    });

    it('should generate correct file paths for different commands', () => {
      expect(cursorAdapter.getFilePath('new')).toBe(path.join('.cursor', 'commands', 'ofsx-new.md'));
      expect(cursorAdapter.getFilePath('bulk-archive')).toBe(path.join('.cursor', 'commands', 'ofsx-bulk-archive.md'));
    });
    ...
    it('should format file with Cursor-specific frontmatter', () => {
      ...
      expect(output).toContain('---\n');
      expect(output).toContain('name: "/ofsx-explore"');
      expect(output).toContain('id: "ofsx-explore"');
      expect(output).toContain('category: "Workflow"');
      expect(output).toContain('description: "Enter explore mode for thinking"');
      expect(output).toContain('---\n\n');
      expect(output).toContain('This is the command body.');
  ...
  describe('commandCodeAdapter', () => {
    ...
    it('should generate correct file path with ofsx- prefix', () => {
      ...
      expect(filePath).toBe(path.join('.commandcode', 'commands', 'ofsx-explore.md'));
    });
    ...
    it('is generated by generateCommand with hyphen command references', () => {
      const contentWithCommands: CommandContent = {
        ...sampleContent,
        body: 'Use /ofsx:new to start, then /ofsx:apply to implement.',
      };
      ...
      expect(output).not.toContain('/ofsx:apply');
    });
  });
  ...
  describe('devinAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.devin', 'workflows', 'ofsx-explore.md'));
    });
    ...
    // The body's `/ofsx:*` references are rewritten to the `/ofsx-*` form
  ...
  describe('amazonQAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.amazonq', 'prompts', 'ofsx-explore.md'));
    });
  ...
  describe('antigravityAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.agents', 'workflows', 'ofsx-explore.md'));
    });
  ...
  describe('auggieAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.augment', 'commands', 'ofsx-explore.md'));
    });
  ...
  describe('bobAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.bob', 'commands', 'ofsx-explore.md'));
    });

    it('should generate correct file paths for different commands', () => {
      expect(bobAdapter.getFilePath('new')).toBe(path.join('.bob', 'commands', 'ofsx-new.md'));
      expect(bobAdapter.getFilePath('bulk-archive')).toBe(path.join('.bob', 'commands', 'ofsx-bulk-archive.md'));
    });
    ...
    it('is generated by generateCommand with hyphen command references', () => {
      const contentWithRefs: CommandContent = {
        ...sampleContent,
        body: 'Run /ofsx:apply to implement. Then use /ofsx:verify.',
      };
      const output = generateCommand(contentWithRefs, bobAdapter).fileContent;
      expect(output).toContain('/ofsx-apply');
      expect(output).toContain('/ofsx-verify');
      expect(output).not.toContain('/ofsx:apply');
      expect(output).not.toContain('/ofsx:verify');
    });
  ...
  describe('clineAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.clinerules', 'workflows', 'ofsx-explore.md'));
    });
  ...
  describe('codebuddyAdapter', () => {
    ...
    it('should generate correct file path with nested opsx folder', () => {
      ...
      expect(filePath).toBe(path.join('.codebuddy', 'commands', 'ofsx', 'explore.md'));
    });
  ...
  describe('continueAdapter', () => {
    ...
    it('should generate correct file path with .prompt extension', () => {
      ...
      expect(filePath).toBe(path.join('.continue', 'prompts', 'ofsx-explore.prompt'));
    });
  ...
  describe('costrictAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.cospec', 'openspec', 'commands', 'ofsx-explore.md'));
    });
  ...
  describe('crushAdapter', () => {
    ...
    it('should generate correct file path with nested opsx folder', () => {
      ...
      expect(filePath).toBe(path.join('.crush', 'commands', 'ofsx', 'explore.md'));
    });
  ...
  describe('factoryAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.factory', 'commands', 'ofsx-explore.md'));
    });
  ...
  describe('geminiAdapter', () => {
    ...
    it('should generate correct file path with .toml extension', () => {
      ...
      expect(filePath).toBe(path.join('.gemini', 'commands', 'ofsx', 'explore.toml'));
    });
  ...
  describe('githubCopilotAdapter', () => {
    ...
    it('should generate correct file path with .prompt.md extension', () => {
      ...
      expect(filePath).toBe(path.join('.github', 'prompts', 'ofsx-explore.prompt.md'));
    });
  ...
  describe('iflowAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.iflow', 'commands', 'ofsx-explore.md'));
    });
  ...
  describe('kilocodeAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.kilocode', 'workflows', 'ofsx-explore.md'));
    });
  ...
  describe('opencodeAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.opencode', 'commands', 'ofsx-explore.md'));
    });
    ...
    it('is generated by generateCommand with every reference hyphenated', () => {
      const contentWithMultipleCommands: CommandContent = {
        ...sampleContent,
        body: `/ofsx:explore for ideas
/ofsx:new to create
/ofsx:continue to proceed
/ofsx:apply to implement`,
      };
      const output = generateCommand(contentWithMultipleCommands, opencodeAdapter).fileContent;
      expect(output).toContain('/ofsx-explore');
      expect(output).toContain('/ofsx-new');
  ...
  describe('qoderAdapter', () => {
    ...
    it('should generate correct file path with nested opsx folder', () => {
      ...
      expect(filePath).toBe(path.join('.qoder', 'commands', 'ofsx', 'explore.md'));
    });
  ...
  describe('qwenAdapter', () => {
    ...
    it('should generate correct file path with .md extension', () => {
      ...
      expect(filePath).toBe(path.join('.qwen', 'commands', 'ofsx-explore.md'));
    });
    ...
    it('is generated by generateCommand with hyphen command references', () => {
      // Qwen commands are invoked by filename (/ofsx-<id>), like bob/opencode.
      const contentWithRefs: CommandContent = {
        ...sampleContent,
        body: 'Run /ofsx:apply to implement. Then use /ofsx:archive.',
      };
      const output = generateCommand(contentWithRefs, qwenAdapter).fileContent;
      expect(output).toContain('/ofsx-apply');
      expect(output).toContain('/ofsx-archive');
      expect(output).not.toContain('/ofsx:apply');
      expect(output).not.toContain('/ofsx:archive');
    });
  });
  ...
  describe('piAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.pi', 'prompts', 'ofsx-explore.md'));
    });

    it('should generate correct file paths for different commands', () => {
      expect(piAdapter.getFilePath('new')).toBe(path.join('.pi', 'prompts', 'ofsx-new.md'));
      expect(piAdapter.getFilePath('bulk-archive')).toBe(path.join('.pi', 'prompts', 'ofsx-bulk-archive.md'));
    });
    ...
    it('is generated by generateCommand with hyphen command references', () => {
      const contentWithRefs: CommandContent = {
        ...sampleContent,
        body: 'Run /ofsx:apply to implement. Then /ofsx:archive when done.',
      };
    ...
    it('should inject template arguments into the input section', () => {
      const contentWithInput: CommandContent = {
        ...sampleContent,
        body: '**Input**: The argument after `/ofsx:explore` is the topic.\n\n**Steps**\n1. Think.',
      };
  ...
  describe('ohMyPiAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.omp', 'commands', 'ofsx-explore.md'));
    });

    it('should generate correct file paths for different commands', () => {
      expect(ohMyPiAdapter.getFilePath('new')).toBe(path.join('.omp', 'commands', 'ofsx-new.md'));
      expect(ohMyPiAdapter.getFilePath('bulk-archive')).toBe(path.join('.omp', 'commands', 'ofsx-bulk-archive.md'));
    });
  ...
  describe('roocodeAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.roo', 'commands', 'ofsx-explore.md'));
    });
  ...
  describe('traeAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.trae', 'commands', 'ofsx-explore.md'));
    });

    it('should generate correct file paths for different commands', () => {
      expect(traeAdapter.getFilePath('new')).toBe(path.join('.trae', 'commands', 'ofsx-new.md'));
      expect(traeAdapter.getFilePath('bulk-archive')).toBe(path.join('.trae', 'commands', 'ofsx-bulk-archive.md'));
    });
  ...
  describe('zcodeAdapter', () => {
    ...
    it('should generate correct file path under .zcode/commands/opsx', () => {
      ...
      expect(filePath).toBe(path.join('.zcode', 'commands', 'ofsx', 'explore.md'));
    });

    it('should generate correct file paths for different command IDs', () => {
      expect(zcodeAdapter.getFilePath('new')).toBe(path.join('.zcode', 'commands', 'ofsx', 'new.md'));
      expect(zcodeAdapter.getFilePath('bulk-archive')).toBe(path.join('.zcode', 'commands', 'ofsx', 'bulk-archive.md'));
    });
  ...
  describe('cross-platform path handling', () => {
    it('Claude adapter uses path.join for paths', () => {
      ...
      expect(filePath.split(path.sep)).toEqual(['.claude', 'commands', 'ofsx', 'test.md']);
    });

    it('Cursor adapter uses path.join for paths', () => {
      const filePath = cursorAdapter.getFilePath('test');
      expect(filePath.split(path.sep)).toEqual(['.cursor', 'commands', 'ofsx-test.md']);
    });

    it('Devin adapter uses path.join for paths', () => {
      const filePath = devinAdapter.getFilePath('test');
      expect(filePath.split(path.sep)).toEqual(['.devin', 'workflows', 'ofsx-test.md']);
    });
  ...
  describe('codeassistantAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.codeassistant', 'commands', 'ofsx-explore.md'));
    });

    it('should generate correct file path for different command IDs', () => {
      expect(codeassistantAdapter.getFilePath('new')).toBe(path.join('.codeassistant', 'commands', 'ofsx-new.md'));
      expect(codeassistantAdapter.getFilePath('bulk-archive')).toBe(path.join('.codeassistant', 'commands', 'ofsx-bulk-archive.md'));
    });
    ...
    it('generates registered commands with hyphenated workflow references', () => {
      const content: CommandContent = {
        ...sampleContent,
        body: 'Use /ofsx:propose, /ofsx:update, and /ofsx:bulk-archive. Keep /ofsx:unknown.',
      };
      ...
      expect(generated.path).toBe(path.join('.codeassistant', 'commands', 'ofsx-explore.md'));
      expect(generated.fileContent).toContain(
        'Use /ofsx-propose, /ofsx-update, and /ofsx-bulk-archive. Keep /ofsx:unknown.'
      );
      expect(content.body).toContain('/ofsx:propose');
    });
  });
