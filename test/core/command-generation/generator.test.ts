...
describe('command-generation/generator', () => {
  ...
  describe('generateCommand', () => {
    it('should generate command with path and content using Claude adapter', () => {
      ...
      expect(result.fileContent).toContain('name: "OfficeSpec Explore"');
    ...
    it('should generate command for Cursor adapter', () => {
      ...
      expect(result.path).toContain('ofsx-explore.md');
      expect(result.fileContent).toContain('name: "/ofsx-explore"');
      expect(result.fileContent).toContain('id: "ofsx-explore"');
      expect(result.fileContent).toContain('Command body here.');
    });
    ...
    it('should work with custom adapter', () => {
      ...
      expect(result.fileContent).toBe('# OfficeSpec Explore\n\nCommand body here.');
    });
  });
