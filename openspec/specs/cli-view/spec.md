...
The `openspec view` command provides a comprehensive dashboard view of the OfficeSpec project state, displaying specifications, changes, and progress metrics in a unified, visually appealing format to help developers quickly understand project status.
## Requirements
...
#### Scenario: No OfficeSpec directory

- **WHEN** user runs `openspec view` in a directory without OfficeSpec
