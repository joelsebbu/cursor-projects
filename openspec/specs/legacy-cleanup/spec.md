...
## Purpose
Define detection and cleanup behavior for legacy OfficeSpec artifacts during initialization and update workflows.
...
- **THEN** the system SHALL display a summary section:
  ...
  Cleaned up legacy files:
    ...
    ✓ Removed .claude/commands/openspec/ (replaced by OfficeSpec skills and commands)
