...
- Graceful degradation when outside OfficeSpec projects
...
│       ├── command-registry.ts    # Single source of truth for OfficeSpec commands
...
2. **Not in OfficeSpec project** - Skip dynamic completions, only offer static commands
...
3. **Manual Testing**
   ...
   - Tab completion behavior in OfficeSpec projects
