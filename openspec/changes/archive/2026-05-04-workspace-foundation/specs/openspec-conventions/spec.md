...
OfficeSpec conventions SHALL describe coordination workspaces in user-facing product terms.

#### Scenario: Describing workspace structure
- **WHEN** OfficeSpec documentation describes workspace support
...
- **WHEN** OfficeSpec documentation explains what a workspace includes
...
- **WHEN** OfficeSpec documentation explains workspace planning
...
- **WHEN** OfficeSpec documentation compares workspace and repo-local flows
