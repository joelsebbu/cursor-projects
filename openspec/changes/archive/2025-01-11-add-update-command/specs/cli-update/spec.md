...
The update command SHALL update OfficeSpec instruction files to the latest templates.
...
- Update the OfficeSpec-managed block in `CLAUDE.md` using markers
  - Preserve user content outside markers
  - Create `CLAUDE.md` if missing
- Display ASCII-safe success message: "Updated OfficeSpec instructions"
...
- Display error: "No OfficeSpec directory found. Run 'openspec init' first."
- Exit with code 1
...
- Update OfficeSpec instructions with a single command
