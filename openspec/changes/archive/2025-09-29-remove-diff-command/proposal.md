...
The `openspec diff` command adds unnecessary complexity to the OfficeSpec CLI for several reasons:
...
- **Better alignment**: Focuses on the core OfficeSpec workflow without redundant features
