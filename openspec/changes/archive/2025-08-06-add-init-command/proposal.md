# Add Init Command for OfficeSpec

## Why

Projects need a simple way to adopt OfficeSpec conventions. Currently, users must manually create the directory structure and understand all the conventions, which creates friction for adoption. An init command would enable instant OfficeSpec setup with proper structure and guidance.

## What Changes

- Add `openspec init` CLI command that creates the complete OfficeSpec directory structure
...
- Validation to prevent overwriting existing OfficeSpec structures
