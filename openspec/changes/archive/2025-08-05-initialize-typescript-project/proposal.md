...
## Why
The OfficeSpec project needs a proper TypeScript foundation to build the minimal CLI that helps developers set up OfficeSpec file structures and keep AI instructions updated.
