...
Define the install scope model for OfficeSpec-generated skills and commands, including scope preference, effective scope resolution, and fallback/error semantics.
...
- **AND** SHALL automatically remove only OfficeSpec-managed files in the previous effective scope
