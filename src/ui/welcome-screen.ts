...
function getWelcomeText(workflows: readonly string[]): string[] {
  ...
  if (onboardingCommands.length > 0) {
    ...
    // (/ofsx-propose, @ofsx-propose, $officespec-propose ...) and cannot be known
