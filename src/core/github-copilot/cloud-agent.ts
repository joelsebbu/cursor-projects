 ...
 * This workflow pre-installs the OpenSpec CLI in the Copilot AI assistant's
 ...
 * This tells the GitHub Copilot AI assistant how to use the OpenSpec CLI.
 */
...
OpenSpec is a structured change management system for teams. It organizes work into **changes** with planning artifacts (proposals, specs, plans, tasks) that guide delivery.
