...
Scan the workspace for small improvement opportunities. Look for:
...
**If nothing found:** Fall back to asking what the user wants to do:
> I didn't find obvious quick wins in your workspace. What's something small you've been meaning to add or fix?
...
└── tasks.md       ← Action checklist (empty)
```
...
`expense-approvals` or `finance/expense-approvals`). Use the exact existing path for modified
...
<Description of what the work should achieve>
...
Finally, we break the work into work tasks—checkboxes that drive the apply phase.
...
```
Here are the work tasks:

---

## 1. [Category or file]

- [ ] 1.1 [Specific task] — verify: [check, review, observable outcome, or delivered artifact]
- [ ] 1.2 [Specific task] — verify: [check, review, observable outcome, or delivered artifact]

## 2. Integration Verification

- [ ] 2.1 Verify [broader outcome] with [review or observable result]

---

Each checkbox becomes a unit of work in the apply phase. Ready to do the work?
```

**PAUSE** - Wait for user to confirm they're ready to do the work.

Save to the `resolvedOutputPath` from `openspec instructions tasks --change "<name>" --json`.

---

## Phase 9: Apply (Do the work)

**EXPLAIN:**
```
## Doing the work

Now we carry out each task, checking them off as we go. I'll announce each one and occasionally note how the specs/plan informed the approach.
```

**DO:** For each task:

1. Announce: "Working on task N: [description]"
2. Carry out the change in the workspace
3. Reference specs/design naturally: "The spec says X, so I'm doing Y"
4. Mark complete in tasks.md: `- [ ]` → `- [x]`
5. Brief status: "✓ Task N complete"

Keep narration light—don't over-explain every step.
...
The change is now part of your team's history. The work is done, the decision record is preserved.
```
...
- **Keep narration light** while doing the work—teach without lecturing
