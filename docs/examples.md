...
```text
You: /opsx:propose add-expense-checklist
...
```text
You: /opsx:propose fix-expense-routing
...
Start with `/opsx:explore`. It's a thinking partner with no structure and no artifacts created. It reads your workspace and helps you decide.
...
You: /opsx:propose speed-up-expense-approvals
...
You: /opsx:propose fix-invoice-routing
