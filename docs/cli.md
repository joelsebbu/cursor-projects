...
|----------|----------|---------|
| **Setup** | `init`, `update` | Initialize and update OpenSpec in your work |
...
Initialize OpenSpec in your work. Creates the folder structure and configures AI tool integrations.
